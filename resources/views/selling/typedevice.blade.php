  ...
  <body x-init="" style="" cz-shortcut-listen="true">
    ...
    <main class="wrapper">
      ...
      <section class="container mt-3 mb-5" data-models="">
        <div class="wf-step sal-animate" aria-label="stepper" role="navigation" data-sal="fade-in" data-sal-delay="200" data-sal-duration="200" data-sal-once="data-sal-once">
            ...
            <sl-resize-observer>
                ...
                <a class="wf-step__item wf-step__item--active" href="#" aria-label="Marque">
                  ...
                  <div class="wf-step__item--text" aria-current="page">Type d'appareil</div>
                </a>
        ...
        <div class="wf-heading--md wf-align--center sal-animate" data-sal="slide-up" data-sal-delay="400" data-sal-duration="300">Quel est votre type d'apareil ? </div>
        ...
        <div class="wf-grid wf-grid--devices wf-mt--4 wf-mb--3 data-grid-html" data-grid="">
            ...
            @foreach ($typedevices as $typedevice)
                <sl-card class="wf-card wf-card--model sal-animate"  data-grid-item="" data-sal="slide-up" data-sal-delay="100" data-sal-duration="200">
                    <a href="{{ route('stepsellings.create', ['typedevice' => $typedevice]) }}">
                    <img src="{{asset('images/'. $typedevice->image )}}" alt="">
                    </a>
                    <div class="wf-name wf-paragraph--xs wf-weight--bold wf-font--mts wf-align--center">Revendez vos {{strtolower($typedevice->name)}} </div>
                    <span>Jusqu'à <strong>{{$typedevice->estimate_price}}€</strong> </span>
