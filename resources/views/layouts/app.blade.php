          ...
          <div class="wf-aside__screen modal-content" x-show="protection" style="display: none;">
            ...
            <div class="wf-aside__protection-content modal-body">
              ...
              <a class="wf-aside__protection-content-card" href="#" aria-label="Protection Apple">
                <img src="{{asset('layout/apple(2).webp')}}" srcset="{{asset('images/navbar/xforce/aside/apple.webp')}}" alt="Apple" width="100%" height="100%" loading="lazy" draggable="false" oncontextmenu="return false">
              ...
              <a class="wf-aside__protection-content-card" href="#" aria-label="Protection Samsung">
                <img src="{{asset('layout/samsung(3).webp')}}" srcset="{{asset('images/navbar/xforce/aside/samsung.webp')}}" alt="Samsung" width="100%" height="100%" loading="lazy" draggable="false" oncontextmenu="return false">
                <div class="wf-aside__protection-content-card-body">
              ...
              <a class="wf-aside__protection-content-card" href="#" aria-label="Protection Xiaomi">
                <img src="{{asset('layout/xiaomi(1).webp')}}" srcset="{{asset('images/navbar/xforce/aside/xiaomi.webp')}}" alt="Xiaomi" width="100%" height="100%" loading="lazy" draggable="false" oncontextmenu="return false">
                <div class="wf-aside__protection-content-card-body">
              ...
              <a class="wf-aside__protection-content-card" href="#" aria-label="Protection Huawei">
                <img src="{{asset('layout/huawei(3).webp')}}" srcset="{{asset('images/navbar/xforce/aside/huawei.webp')}}" alt="Huawei" width="100%" height="100%" loading="lazy" draggable="false" oncontextmenu="return false">
                <div class="wf-aside__protection-content-card-body">
              ...
              <a class="wf-aside__protection-content-card" href="#" aria-label="Protection OPPO">
                <img src="{{asset('layout/oppo(2).webp')}}" srcset="{{asset('images/navbar/xforce/aside/oppo.webp')}}" alt="OPPO" width="100%" height="100%" loading="lazy" draggable="false" oncontextmenu="return false">
                <div class="wf-aside__protection-content-card-body">
              ...
              <a class="wf-aside__protection-content-card" href="#" aria-label="Protection Google">
                <img src="{{asset('layout/google(1).webp')}}" srcset="{{asset('images/navbar/xforce/aside/google.webp')}}" alt="Google" width="100%" height="100%" loading="lazy" draggable="false" oncontextmenu="return false">
                <div class="wf-aside__protection-content-card-body">
          ...
          <div class="wf-banner-list swiper-wrapper" style="transform: translate3d(-1161px, 0px, 0px); transition-duration: 900ms;">
            <div class="wf-banner-list--item swiper-slide swiper-slide-next" tabindex="-1" style="width: 357px; margin-right: 30px;" data-swiper-slide-index="1">
              <a href="#" aria-label="Deezer vous offre 4 mois d&#39;abonnement pour tout achat chez WeFix">
                <picture>
                  <source type="image/webp" srcset="{{asset('images/banner-mobile.webp 3840w')}}" media="(max-width: 767px)" width="750" height="750">
                  <img fetchpriority="high" src="{{asset('images/banner-desktop.webp')}}" srcset="{{asset('
                images/banner-desktop.webp 260w,
                images/banner-desktop.webp 828w,
                images/banner-desktop.webp 1080w,
                images/banner-desktop.webp 1200w,
                images/banner-desktop.webp 1920w,
                images/banner-desktop.webp 2048w,
                images/banner-desktop.webp 3840w
                ')}}" alt="Deezer vous offre 4 mois d&#39;abonnement pour tout achat chez WeFix" width="3360" height="800" loading="lazy" sizes="100vw" oncontextmenu="return false">
                </picture>
              </a>
            </div>
            <div class="wf-banner-list--item swiper-slide" tabindex="-1" style="width: 357px; margin-right: 30px;" data-swiper-slide-index="2">
              <a href="#" aria-label="Réparer votre smartphone !">
                ...
                images/banner-desktop.webp 2048w,
                images/banner-desktop.webp 3840w
                ')}}" alt="Réparer votre smartphone !" width="3360" height="800" loading="lazy" sizes="100vw" oncontextmenu="return false">
                </picture>
              </a>
            </div>
            <div class="wf-banner-list--item swiper-slide swiper-slide-prev" tabindex="-1" style="width: 357px; margin-right: 30px;" data-swiper-slide-index="3">
              <a href="#" aria-label="Protégez vos appareils !">
                ...
                images/banner-desktop.webp 2048w,
                images/banner-desktop.webp 3840w
                ')}}" alt="Protégez vos appareils !" width="3360" height="800" loading="lazy" sizes="100vw" oncontextmenu="return false">
                </picture>
              </a>
            </div>
            <div class="wf-banner-list--item swiper-slide swiper-slide-active" tabindex="-1" style="width: 357px; margin-right: 30px;" data-swiper-slide-index="0">
              <a href="#" aria-label="-10% sur votre réparation en prenant rendez-vous !">
                <picture>
                  <source type="image/webp" srcset="{{asset('images/banner-mobile.webp 3840w')}}" media="(max-width: 767px)" width="750" height="750">
                  <img fetchpriority="high" src="{{asset('images/banner-desktop.webp')}}"
                  srcset="{{asset('
                images/banner-desktop.webp 260w,
                images/banner-desktop.webp 828w,
                images/banner-desktop.webp 1080w,
                ...
                images/banner-desktop.webp 3840w
                ')}}"
                 alt="-10% sur votre réparation en prenant rendez-vous !" width="3360" height="800" loading="lazy" sizes="100vw" oncontextmenu="return false">
                </picture>
              </a>
            </div>
          </div>
                ...
                <template shadowrootmode="open">
                  ...
                  <svg fill="none" height="117" viewBox="0 0 284 117" width="284" xmlns="http://www.w3.org/2000/svg')}}" xmlns:xlink="http://www.w3.org/1999/xlink" part="svg')}}">
                    <pattern id="a" height="1" patternContentUnits="objectBoundingBox" width="1">
                      <image height="1421" transform="matrix(.00029053 0 0 .00070522 0 -.001055)" width="3442" xlink:href="#"></image>
                    </pattern>
                    <path d="m0 0h284v117h-284z" fill="url(#a)"></path>
                  </svg>
                </template>
              </sl-icon>
