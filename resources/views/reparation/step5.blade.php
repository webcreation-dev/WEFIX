...
<html lang="en">
  ...
  <body x-init="" cz-shortcut-listen="true">
    ...
    <main class="wrapper">
      <header class="bg-light navbar-reveal fixed-top shadow none">
      ...
      <header class="bg-light shadow navbar-product navbar-stuck">
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="container-fluid align-items-center mts">
            <div class="d-flex align-items-center">
              <img class="ms-sm-n1 ms-n2" src="{{asset('reparation/HTCDESIRE825.png')}}" srcset="https://intranet.wefix.net/WB/Modeles/HTCDESIRE825.png 1.5x" alt="DESIRE 825" width="70">
                ...
                <div class="wf-corner-card__body">
                  <div class="wf-corner-card__body--header">
                    <div class="wf-corner-card__body--header-title">
                      <span>1.</span> Centre Commercial Cap 3000
                    </div>
                    <div class="wf-corner-card__body--header-info">
                      <div>Avenue Eugène Donadeï,</div>
                      <div>Saint-Laurent-du-Var 06700 - <span class="code">37,94 km</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion">
                    <div class="accordion-item">
                      <div class="accordion-header accordion-hours--header" id="hours0">
                        <div class="accordion-button accordion-hours--header-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapse-hours0" aria-expanded="false" aria-controls="collapse-hours0">
                      ...
                      <div class="accordion-collapse collapse" id="collapse-hours0" aria-labelledby="hours0">
                        <div class="accordion-body">
                          <div class="wf-corner-card__body--hours">
                            <div class="wf-corner-card__body--hours-content">
                              ...
                              <div class="wf-corner-card__body--hours-content--end">20:30 </div>
                  ...
                  <div class="wf-corner-card__body--footer">
                    <sl-button class="wf-button wf-button--primary" data-boutique-id="0602" data-boutique-style="reparation" data-boutique-submit="data-boutique-submit" size="large" variant="default" data-optional="" data-valid="">
                      Prendre rendez-vous
                    </sl-button>
                  </div>
                </div>
