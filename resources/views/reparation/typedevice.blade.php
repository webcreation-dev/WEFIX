    ...
    <main class="wrapper">
      ...
      <section class="mt-md-5 mt-4">
        <div class="container">
          ...
          <div class="mt-5">
            <div class="title-section" data-sal="slide-up" data-sal-delay="400" data-sal-duration="300">Votre réparation garantie</div>
            <p class="mt-3">Exigez le meilleur pour votre smartphone, votre tablette ou votre console de jeu en nous confiant sa réparation. Récupérez votre appareil comme neuf après seulement <strong> 1 heure</strong>. </p>
