  ...
  <body x-init="" cz-shortcut-listen="true">
    ...
    <main class="wrapper">
            ...
            <div class="navbar-tool">
              <div class="d-none d-md-block">
                <div class="d-flex align-items-center">
                  <img class="ms-sm-n1 ms-n2" src="{{asset('reparation/HTCDESIRE825.png')}}" srcset="https://intranet.wefix.net/WB/Modeles/HTCDESIRE825.png 1.5x" alt="DESIRE 825" width="70">
                  <div class="d-flex flex-column">
                    <div class="text-dark fs-14 fw-medium">HTC</div>
                    <span class="title-section fs-21 text-primary ellipsis-navbar-text">DESIRE 825</span>
                  </div>
                </div>
              </div>
              <div class="d-flex flex-column align-items-end ms-auto">
                ...
                <div class="d-flex flex-sm-row flex-column align-items-end mt-1">
                  <span class="title-section fs-21 text-primary">9.90€</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="container-fluid align-items-center mts">
            <div class="d-flex align-items-center">
              <img class="ms-sm-n1 ms-n2" src="{{asset('reparation/HTCDESIRE825.png')}}" srcset="https://intranet.wefix.net/WB/Modeles/HTCDESIRE825.png 1.5x" alt="DESIRE 825" width="70">
              <div class="d-flex flex-column">
                <div class="text-dark fs-14 fw-medium d-none d-sm-block">HTC</div>
                <div class="d-flex flex-sm-row flex-column align-items-start scroll-device">
                  <div class="text-dark fs-14 fw-medium me-2 d-sm-none">HTC</div>
                  <span class="title-section fs-21 text-primary scroll-device-text">DESIRE 825</span>
                </div>
              </div>
            </div>
      ...
      <section class="container my-3">
        ...
        <form class="form wf-form-client-reparation mt-4" method="POST" novalidate="">
          <div class="grid" style="--wf-gap: 16px">
            <div class="d-flex g-col-sm-6 g-col-12">
              <input class="btn-check" type="radio" id="MR" name="civility" value="MR" checked="f">
              <label class="btn btn-outline-primary fw-medium w-50 me-2" for="MR">Monsieur</label>
              <input class="btn-check" type="radio" id="MME" name="civility" value="MME">
          ...
          <div class="grid mt-3" style="--wf-gap: 16px">
            <div class="g-col-sm-6 g-col-12">
              <div class="form-floating">
                <input class="form-control" type="text" name="surname" id="surname" style="text-transform: capitalize" placeholder="..." maxlength="40" autofocus="" autocomplete="" required="">
            ...
            <div class="g-col-sm-6 g-col-12">
              <div class="form-floating">
                <input class="form-control" type="text" name="surname" id="name" style="text-transform: capitalize" placeholder="..." maxlength="40" autocomplete="" required="">
            ...
            <div class="g-col-12">
              <div class="form-floating">
                <input class="form-control" type="email" name="mail" id="mail" placeholder="..." maxlength="60" autocomplete="" required="">
            ...
            <div class="g-col-sm-6 g-col-12">
              <div class="form-floating">
                <input class="form-control" type="number" name="postal" id="postal" placeholder="..." inputmode="numeric" oninput="this.value = this.value.replace(/D+/g, &#39;&#39;)" required="">
            ...
            <div class="g-col-12">
              <div class="form-floating">
                <input class="form-control" type="number" name="phone" id="phone" placeholder="..." inputmode="numeric" oninput="this.value = this.value.replace(/D+/g, &#39;&#39;)" autocomplete="" required="">
          ...
          <div class="text-center mt-md-3 mt-5">
            <button class="btn btn-lg cta-primary" type="submit" data-event-type="rdv" data-label-form-submit="" size="large">PRENDRE RENDEZ-VOUS</button>
            <button class="btn btn-link fs-lg fw-bold text-dark underline wf-mt--2" type="submit" data-event-type="devis" data-label-devis-submit="" size="medium">Recevoir mon devis </button>
          </div>
        </form>
