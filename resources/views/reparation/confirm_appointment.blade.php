              ...
              <div class="widget px-lg-2 py-2 mb-3">
                ...
                <div class="d-flex justify-content-between align-items-center p-2 border-bottom">
                  <div class="d-flex align-items-center me-2">
                    <img class="rounded-1" src="{{asset('reparation/restauration.webp')}}" srcset="https://intranet.wefix.net/WB/services/restauration.webp 1.5x" alt="Restauration effacement des données" width="35">
                    <div class="d-flex-flex-column ms-2">
                      <div>
                        <span class="widget-product-title title-section fw-medium fs-16 mb-0">Restauration effacement des données</span>
                        <span class="badge rounded-pill bg-green ms-2">-NaN%</span>
                      </div>
                    </div>
                  </div>
                  <div class="d-flex flex-column">
                    <s class="text-grey fw-medium">9.90€</s>
                    <div class="title-section fw-bold text-green fs-16">9.90€</div>
                  </div>
                </div>
                <ul class="list-unstyled fs-sm pt-3 pb-2 border-bottom" role="list">
                  <li class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="title-section fw-bold text-dark fs-lg">9.90€</div>
                  </li>
                  <li class="d-flex justify-content-between align-items-center pt-1">
                    ...
                    <div class="title-section fw-bold text-green fs-lg">0.00€</div>
                  </li>
                </ul>
