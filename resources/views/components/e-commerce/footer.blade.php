            ...
            <div class="container">
                <div class="row">
                    <div class="text-center footer-off-msg">
                        <span>MAYDAYPHONE | La première place de marché dédiée aux produits reconditionnés.</span>
                ...
                <div class="row">
                    ...
                    {{-- <div class="col-sm-12 col-lg-3 ec-footer-news">
                        <div class="ec-footer-widget">
                            ...
                            <div class="ec-footer-links">
                                <ul class="align-items-center">
                                    <li class="ec-footer-link">Recevez des mises à jour instantanées sur nos nouveaux produits et promotions spéciales !</li>
                                </ul>
                                    ...
                                    <form id="ec-newsletter-form" name="ec-newsletter-form" method="post"
                                        ...
                                        <div id="ec_news_signup" class="ec-form">
                                            <input class="ec-email" type="email" required=""
                                                placeholder="Entre votre email ici..." name="ec-email" value="" />
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col text-center footer-copy">
                        <div class="footer-bottom-copy ">
                            <div class="ec-copy">Copyright © 2023 by<a class="site-name text-upper"
                                    href="#">HORIZONS PLUS<span>.</span></a>. Tous droits réservés</div>
                        </div>
                    </div>
...
@livewire('cart-float-controller')
